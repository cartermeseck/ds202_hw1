...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Carter Meseck** and my major is *Data Science*, which is the reason I am taking this class.
    I really enjoy looking at data and trying to extract meaning and information about how to do something more efficiently. In video games I would run experiements to see how much money I was making, then compile that data and
compare it to other methods. This kind of lead to me figuring out it's an actual job, so I'm happy to be here and learn more!
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job related to data science is a data scientist. These are people whose job it is to work with data, by organizing and cleaning it up. These people then will run tests on this data to find patterns in order to benefit the company that they work for. [What does a data scientist do?](https://www.northeastern.edu/graduate/blog/what-does-a-data-scientist-do/) ![Caption](ds.jpg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I think the topic I will be most interested in is anything to do about video games, and/or movies.
    Doing research about what movies/games people like and how well those movies/games perform is really interesting to me.
